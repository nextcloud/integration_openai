OC.L10N.register(
    ...
    "Watsonx.ai admin options saved" : "Watsonx.ai admin options saved",
    "Failed to save watsonx.ai admin options" : "Failed to save watsonx.ai admin options",
    "The Assistant app is not enabled. You need it to use the features provided by the watsonx.ai integration app." : "The Assistant app is not enabled. You need it to use the features provided by the watsonx.ai integration app.",
    "Assistant app" : "Assistant app",
    "Service URL" : "Service URL",
    "Example: {example}" : "Example: {example}",
    "Leave empty to use {watsonxApiUrl}" : "Leave empty to use {watsonxApiUrl}",
    ...
    "This should include the domain name and API base path of your watsonx.ai instance. This URL will be accessed by your Nextcloud server." : "This should include the domain name and API base path of your watsonx.ai instance. This URL will be accessed by your Nextcloud server.",
    "Service name (optional)" : "Service name (optional)",
    "Example: watsonx.ai of university ABC" : "Example: watsonx.ai of university ABC",
    ...
    "API key (mandatory with watsonx.ai)" : "API key (mandatory with watsonx.ai)",
    "You can create an API key in your IBM Cloud IAM account settings" : "You can create an API key in your IBM Cloud IAM account settings",
    "Cloud Resources" : "Cloud Resources",
    "Project ID" : "Project ID",
    "Space ID" : "Space ID",
    "A watsonx.ai project ID or space ID is required to generate text" : "A watsonx.ai project ID or space ID is required to generate text",
    ...
    "More information about IBM watsonx.ai as a Service" : "More information about IBM watsonx.ai as a Service",
    "More information about the IBM watsonx.ai software" : "More information about the IBM watsonx.ai software",
    ...
    "Watsonx.ai options saved" : "Watsonx.ai options saved",
    "Failed to save watsonx.ai options" : "Failed to save watsonx.ai options",
    ...
    "API key" : "API key",
    "A watsonx.ai project ID or space ID is required if an API key is specified" : "A watsonx.ai project ID or space ID is required if an API key is specified",
