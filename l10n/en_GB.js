OC.L10N.register(
    ...
    "Extra completion model parameters (as a JSON object)" : "Extra completion model parameters (as a JSON object)",
    ...
    "Check the API documentation to get the list of all available parameters. For example: {example}" : "Check the API documentation to get the list of all available parameters. For example: {example}",
