OC.L10N.register(
    ...
    "The ID of the audio response returned by the remote service" : "Die ID, der Audio-Antwort, die vom Remote-Service zurückgegeben wird",
    "Remote audio expiration date" : "Remote-Audio Ablaufdatum",
    "The remote audio response stays available in the service until this date" : "Die Remote-Audio-Anwort steht bis zu diesem Datum beim Service zur Verfügung",
    "Language" : "Sprache",
    ...
    "Timeout for the request to the external API" : "Timeout der Anfrage an die externe API",
