OC.L10N.register(
    ...
    "This should include the address of your LocalAI instance (or any service implementing an API similar to OpenAI) along with the root path of the API. This URL will be accessed by your Nextcloud server." : "Diese sollte die Adresse deiner LocalAI-Instanz (oder eines beliebigen Dienstes, der eine OpenAI-ähnliche API implementiert) zusammen mit dem Stammpfad der API enthalten. Auf diese URL wird von deinem Nextcloud-Server zugegriffen.",
