OC.L10N.register(
    ...
    "⚠️ The smart pickers have been removed from this app\nas they are now included in the [Assistant app](https://apps.nextcloud.com/apps/assistant).\n\nThis app implements:\n\n* Text generation providers: Free prompt, Summarize, Headline, Context Write, Chat, and Reformulate (using any available large language model)\n* A Translation provider (using any available language model)\n* A SpeechToText provider (using Whisper)\n* An image generation provider\n\n⚠️ Context Write, Summarize, Headline and Reformulate have mainly been tested with OpenAI.\nThey might work when connecting to other services, without any guarantee.\n\nInstead of connecting to the OpenAI API for these, you can also connect to a self-hosted [LocalAI](https://localai.io) instance\nor to any service that implements an API similar to the OpenAI one, for example: [Plusserver](https://www.plusserver.com/en/ai-platform/) or [MistralAI](https://mistral.ai).\n\n⚠️ This app is mainly tested with OpenAI. We do not guarantee it works perfectly\nwith other services that implement OpenAI-compatible APIs with slight differences.\n\n## Ethical AI Rating\n### Rating for Text generation using ChatGPT via the OpenAI API: 🔴\n\nNegative:\n* The software for training and inference of this model is proprietary, limiting running it locally or training by yourself\n* The trained model is not freely available, so the model can not be run on-premises\n* The training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model's performance and CO2 usage.\n\n\n### Rating for Translation using ChatGPT via the OpenAI API: 🔴\n\nNegative:\n* The software for training and inference of this model is proprietary, limiting running it locally or training by yourself\n* The trained model is not freely available, so the model can not be run on-premises\n* The training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model's performance and CO2 usage.\n\n### Rating for Image generation using DALL·E via the OpenAI API: 🔴\n\nNegative:\n* The software for training and inferencing of this model is proprietary, limiting running it locally or training by yourself\n* The trained model is not freely available, so the model can not be ran on-premises\n* The training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model’s performance and CO2 usage.\n\n\n### Rating for Speech-To-Text using Whisper via the OpenAI API: 🟡\n\nPositive:\n* The software for training and inferencing of this model is open source\n* The trained model is freely available, and thus can run on-premise\n\nNegative:\n* The training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model’s performance and CO2 usage.\n\n### Rating for Text generation via LocalAI: 🟢\n\nPositive:\n* The software for training and inferencing of this model is open source\n* The trained model is freely available, and thus can be ran on-premises\n* The training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n\n### Rating for Image generation using Stable Diffusion via LocalAI : 🟡\n\nPositive:\n* The software for training and inferencing of this model is open source\n* The trained model is freely available, and thus can be ran on-premises\n\nNegative:\n* The training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model’s performance and CO2 usage.\n\n\n### Rating for Speech-To-Text using Whisper via LocalAI: 🟡\n\nPositive:\n* The software for training and inferencing of this model is open source\n* The trained model is freely available, and thus can be ran on-premises\n\nNegative:\n* The training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model’s performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "⚠️ 智慧選擇器已從此應用程式中刪除\n因為它們現在包含在[助手應用程式](https://apps.nextcloud.com/apps/assistant)中。\n\n該應用程式實作：\n\n* 文字產生提供者：免費提示、摘要、標題、上下文編寫、聊天和重新編寫（使用任何可用的大型語言模型）\n* 翻譯提供者（使用任何可用的語言模型）\n* SpeechToText 提供者（使用 Whisper）\n* 圖像生成提供者\n\n⚠️ Context Write、Summarize、Headline 和 Reformulate 主要使用 OpenAI 進行了測試。\n它們可能在連接到其他服務時起作用，但沒有任何保證。\n\n您也可以連接到自託管的 [LocalAI](https://localai.io) 實例，而不是連接到 OpenAI API 來實現這些功能\n或任何實作與 OpenAI 類似的 API 的服務，例如：[Plusserver](https://www.plusserver.com/en/ai-platform/) 或 [MistralAI](https://mistral.ai )。\n\n⚠️這個應用程式主要是用OpenAI進行測試的。我們不保證其完美運行\n與實作 OpenAI 相容 API 的其他服務略有不同。\n\n## 道德人工智慧評級\n### 透過 OpenAI API 使用 ChatGPT 產生文字的評分：🔴\n\n消極的：\n* 此模型的訓練和推理軟體是專有的，限製本地運行或自行訓練\n* 訓練好的模型不是免費提供的，因此模型無法在本地運行\n* 訓練資料不是免費提供的，這限制了外部各方檢查和糾正偏差或優化模型性能和二氧化碳使用的能力。\n\n\n### 透過 OpenAI API 使用 ChatGPT 進行翻譯評分：🔴\n\n消極的：\n* 此模型的訓練和推理軟體是專有的，限製本地運行或自行訓練\n* 訓練好的模型不是免費提供的，因此模型無法在本地運行\n* 訓練資料不是免費提供的，這限制了外部各方檢查和糾正偏差或優化模型性能和二氧化碳使用的能力。\n\n### 透過 OpenAI API 使用 DALL·E 產生影像的評分：🔴\n\n消極的：\n* 此模型的訓練和推理軟體是專有的，限制在本地運行或自行訓練\n* 訓練好的模型不是免費提供的，因此模型不能在本地運行\n* 訓練資料不是免費提供的，這限制了外部各方檢查和糾正偏差或優化模型性能和二氧化碳使用的能力。\n\n\n### 透過 OpenAI API 使用 Whisper 進行語音轉文字的評分：🟡\n\n積極的：\n* 此模型的訓練和推理軟體是開源的\n* 經過訓練的模型是免費提供的，因此可以在本地運行\n\n消極的：\n* 訓練資料不是免費提供的，這限制了外部各方檢查和糾正偏差或優化模型性能和二氧化碳使用的能力。\n\n### 透過 LocalAI 產生文字的評分：🟢\n\n積極的：\n* 此模型的訓練和推理軟體是開源的\n* 經過訓練的模型是免費提供的，因此可以在本地運行\n* 訓練資料免費提供，可以檢查或修正偏差或優化效能和二氧化碳使用量。\n\n\n### 透過 LocalAI 使用穩定擴散進行影像生成的評分：🟡\n\n積極的：\n* 此模型的訓練和推理軟體是開源的\n* 經過訓練的模型是免費提供的，因此可以在本地運行\n\n消極的：\n* 訓練資料不是免費提供的，這限制了外部各方檢查和糾正偏差或優化模型性能和二氧化碳使用的能力。\n\n\n### 透過 LocalAI 使用 Whisper 進行語音轉文字的評分：🟡\n\n積極的：\n* 此模型的訓練和推理軟體是開源的\n* 經過訓練的模型是免費提供的，因此可以在本地運行\n\n消極的：\n* 訓練資料不是免費提供的，這限制了外部各方檢查和糾正偏差或優化模型性能和二氧化碳使用的能力。\n\n了解有關 Nextcloud 道德 AI 評級的更多資訊 [在我們的部落格中](https://nextcloud.com/blog/nextcloud-ethical-ai- rating/)。",
    "Service URL" : "服務 URL",
    "Example: {example}" : "範例：{example}",
    "Leave empty to use {openaiApiUrl}" : "留空以使用 {openaiApiUrl}",
    "This should be the address of your LocalAI instance (or any service implementing an API similar to OpenAI). This URL will be accessed by your Nextcloud server." : "這應該是您的 LocalAI 實例（或任何實作類似 OpenAI 的 API 的服務）的網址。您的 Nextcloud 伺服器將存取此 URL。",
    "This can be a local address with a port like {example}. In this case make sure 'allow_local_remote_servers' is set to true in config.php" : "這可以是類似 {example} 的連接埠的本機網址。在這種情況下，請確保 config.php 中的「allow_local_remote_servers」設定為 true",
