OC.L10N.register(
    ...
    "A per-user quota for each quota type can be set. If the user has not provided their own API key, this quota will be enforced." : "每種配額類型可設定每個使用者的配額。如果使用者未提供自己的 API 金鑰，則會強制執行此配額。",
