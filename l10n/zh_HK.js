OC.L10N.register(
    ...
    "Extra completion model parameters (as a JSON object)" : "額外完成模型參數（以 JSON 對象形式）",
    ...
    "Check the API documentation to get the list of all available parameters. For example: {example}" : "查看 API 說明書以獲取所有可用參數清單。例如：{example}",
