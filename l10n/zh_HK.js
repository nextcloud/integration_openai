OC.L10N.register(
    ...
    "Multimodal LLM Support allows you to enable or disable the use of images, audio, video and document attachments in the LLM." : "多模態 LLM 支援可讓你啟用或停用 LLM 中的影像、音訊、影片及文件附件。",
