OC.L10N.register(
    ...
    "This should be the address of your LocalAI instance (or any service implementing an API similar to OpenAI). This URL will be accessed by your Nextcloud server." : "Toto by měla být adresa vámi využívané instance LocalAI (nebo jiné služby implementující API podobné tomu od OpenAI). K této adrese bude přistupováno vámi využívaným Nextcloud serverem.",
