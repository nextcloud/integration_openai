OC.L10N.register(
    ...
    "IBM watsonx.ai integration" : "Napojení na IBM watsonx.ai",
    "Integration of IBM watsonx AI services" : "Napojení na AI služby IBM watsonx",
    ...
    "Watsonx.ai admin options saved" : "Předvolby správy pro Watsonx.ai uloženy",
    "Failed to save watsonx.ai admin options" : "Předvolby správy pro watsonx.ai se nepodařilo uložit",
    "The Assistant app is not enabled. You need it to use the features provided by the watsonx.ai integration app." : "Aplikace Asistent není zapnutá. Té je zapotřebí pro používání funkcí poskytovaných aplikací pro napojení na watsonx.ai.",
    "Assistant app" : "Aplikace asistent",
    "Service URL" : "URL adresa služby",
    "Example: {example}" : "Příklad: {example}",
    "Leave empty to use {watsonxApiUrl}" : "Pokud chcete použít {watsonxApiUrl}, nevyplňujte",
    ...
    "This should include the domain name and API base path of your watsonx.ai instance. This URL will be accessed by your Nextcloud server." : "Toto by mělo obsahovat doménový název a základ popisu umístění API rozhraní vámi využívané instance watsonx.ai. K této URL bude vámi využívaný Nextcloud server přistupovat.",
    "Service name (optional)" : "Název služby (volitelné)",
    "Example: watsonx.ai of university ABC" : "Příklad: watsonx.ai přes univerzitu ABC",
    ...
    "API key (mandatory with watsonx.ai)" : "Klíč k API (povinné v případě watsonx.ai)",
    ...
    "Space ID" : "Identif. prostoru",
    "A watsonx.ai project ID or space ID is required to generate text" : "Aby bylo možné vytvářet text, je zapotřebí identif. projektu nebo identif. prostoru v rámci watsonx.ai",
    ...
    "More information about IBM watsonx.ai as a Service" : "Další informace o IBM watsonx.ai v podobě služby",
    "More information about the IBM watsonx.ai software" : "Další informace o software IBM watsonx.ai",
    ...
    "Watsonx.ai options saved" : "Předvolby pro Watsonx.ai uloženy",
