OC.L10N.register(
    ...
    "Unknow API request error." : "未知的 API 請求錯誤。",
    ...
    "A per-user limit for uasge of this API type (0 for unlimited))" : "每個使用者使用此 API 類型的限制（0 為無限制）",
