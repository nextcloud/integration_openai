OC.L10N.register(
    ...
    "Too many files given. A maximum of 500 files is allowed." : "提供的檔案數量過多。最多允許 500 個檔案。",
    "The total size of the input files is too large. A maximum of 50MB is allowed." : "輸入檔案的總大小過大。最大允許大小為 50MB。",
    "Invalid input file type \"%1$s\". Only image files are supported." : "無效的輸入檔案類型「%1$s」。僅支援影像檔。",
    "Invalid input file type \"%1$s\". Only JPEG, PNG, GIF and WebP images are supported." : "無效的輸入檔案類型「%1$s」。僅支援 JPEG、PNG、GIF 與 WebP 格式的圖片。",
    ...
    "The input file type is invalid. Only audio files are allowed." : "輸入檔案類型無效。僅允許音訊檔案。",
    "Less wordy" : "措辭簡潔",
    "Simpler" : "簡化",
