OC.L10N.register(
    ...
    "Multimodal LLM Support allows you to enable or disable the use of images, audio, video and document attachments in the LLM." : "多模態大型語言模型支援功能可讓您啟用或停用在大型語言模型中使用圖片、音訊、視訊及文件附件的功能。",
