OC.L10N.register(
    ...
    "Service name (optional)" : "Servis adı (opsiyonel)",
    ...
    "Text processing provider (to generate text, summarize etc...)" : "Metin işleme sağlayıcısı (metin oluşturmak, özetlemek için vs...)",
    "Image generation provider" : "Resim oluşturma sağlayıcısı",
