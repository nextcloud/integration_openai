OC.L10N.register(
    ...
    "Unknow API request error." : "Unbekannter API-Anfragefehler.",
    ...
    "A per-user limit for uasge of this API type (0 for unlimited))" : "Ein Limit pro Benutzer für die Nutzung dieses API-Typs (0 für unbegrenzt)",
