OC.L10N.register(
    ...
    "ChatGPT-like text generation (by OpenAI)" : "ChatGPT-ähnliche Texterstellung (durch OpenAI)",
    "ChatGPT-like text generation (with LocalAI)" : "ChatGPT-ähnliche Texterstellung (mit LocalAI)",
    "AI image generation (by OpenAI Dall-E 2)" : "KI-Bilderstellung (durch OpenAI Dall-E 2)",
    "AI image generation (with LocalAI)" : "KI-Bilderstellung (mit LocalAI)",
    ...
    "LocalAI's stable diffusion Text-To-Image" : "LocalAIs stabile Diffusion Text-zu-Bild",
    ...
    "Image generation with the Smart Picker" : "Bilderstellung mit dem Smart Picker",
    "Text generation with the Smart Picker" : "Texterstellung mit dem Smart Picker",
    ...
    "The remote image cannot be fetched. It may have been deleted due to not being viewed for a long time." : "Das entfernte Bild kann nicht abgerufen werden. Möglicherweise wurde es gelöscht, da es längere Zeit nicht angezeigt wurde.",
