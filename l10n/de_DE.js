OC.L10N.register(
    ...
    "Extra completion model parameters (as a JSON object)" : "Zusätzliche Parameter des Vervollständigungsmodells (als JSON-Objekt)",
    ...
    "Check the API documentation to get the list of all available parameters. For example: {example}" : "Sehen Sie sich die API-Dokumentation an, um eine Liste aller verfügbaren Parameter zu erhalten. Zum Beispiel: {Beispiel}",
