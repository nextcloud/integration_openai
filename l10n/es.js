OC.L10N.register(
    ...
    "Text processing provider (to generate text, summarize etc...)" : "Proveedor de procesamiento de texto (para generar texto, resumir, etc...)",
