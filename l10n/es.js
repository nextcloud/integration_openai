OC.L10N.register(
    ...
    "Memories" : "Memorias",
    "The memories to be injected into the chat session." : "Memorias que se importarán en la sesión de chat.",
    ...
    "Cannot generate more than 12 images at once" : "No se puede generar más de 12 imágenes a la vez",
    "Cannot generate less than 1 image" : "No se puede generar menos de 1 imágen",
    "Cannot generate images larger than 4096x4096" : "No se puede generar imágenes más grandes que 4096x4096",
    "Voice" : "Voz",
    ...
    "Input text cannot be empty" : "El texto introducido no puede estar vacío",
    ...
    "Failed to auto update config" : "Fallo al actualizar la config automáticamente",
    ...
    "This should include the address of your LocalAI instance (or any service implementing an API similar to OpenAI) along with the root path of the API. More often than not \"/v1\" at the end is required even if the model list loads without it. This URL will be accessed by your Nextcloud server." : "Debe incluir la dirección de tu instancia LocalAI (u otro servicio que implemente una API similar a OpenAI) junto con la ruta raíz de la API. Normalmente \"/v1\" al final es necesario aunque la lista de modelos no lo incluya. El servidor Nextcloud utilizará esta URL.",
    ...
    "Max output tokens per request" : "Número máximo de tokens de salida por solicitud",
    "Maximum number of output tokens generated for a single text generation prompt. This also applies to the Speech-to-Text tasks." : "Número máximo de tokens de salida generados para un solo prompt de generación de texto. Esto también aplica para las tareas de Voz a texto.",
    "image generation" : "generación de imágenes",
    ...
    "A per-user quota for each quota type can be set. If the user has not provided their own API key, and a rule is not specified for this user or any of their groups, this quota will be enforced." : "Una cuota de usuario para cada tipo de cuota puede ser definida. Si el usuario no ha provisto su propia clave API, y, una regla no ha sido especificada para este usuario o cualesquiera de sus grupos, esta cuota se hará obligatoria.",
    ...
    "Analyze image provider" : "Proveedor de imágenes de Analyze",
    "This quota period is from {startDate} to {endDate}" : "Este período de cuota es desde {startDate} hasta {endDate}",
    "_The quota is kept over a floating period of the last %n day_::_The quota is kept over a floating period of the last %n days_" : ["La cuota se mantiene en un período flotante del último %n día","La cuota se mantiene en un período flotante de los últimos %n días","La cuota se mantiene en un período flotante de los últimos %n días"],
    ...
    "Speech to Text Default Language" : "Idioma predeterminado para texto a voz",
    ...
    "If you see a shared quota usage of 50% and a usage of 10% that means that you have used 10% of the total shared quota, and the sum of all other users affected by this quota is 40%." : "Si Ud. observa un uso de la cuota compartida del 50% y, un uso del 10%, significa que Ud. ha utilizado un  10% del total de la cuota compartida, y, la suma de todos los otros usuarios afectados por esta cuota es del 40%.",
    ...
    "Days" : "Días",
    "Months" : "Meses",
    "_Quota will be enforced based on last %n day of usage_::_Quota will be enforced based on last %n days of usage_" : ["La cuota se impondrá basándose en el último %n día de uso","La cuota se impondrá basándose en los últimos %n días de uso","La cuota se impondrá basándose en los últimos %n días de uso"],
    "_Quota will reset for all the users every month on day number {nth_day}_::_Quota will reset for all the users every %n months on day number {nth_day}_" : ["La cuota será restablecida para todos los usuarios cada mes en el día número {nth_day}","La cuota será restablecida para todos los usuarios cada %n meses en el día número {nth_day}","La cuota será restablecida para todos los usuarios cada %n meses en el día número {nth_day}"],
    "Quota enforcement time" : "Período de imposición de cuota",
    ...
    "On day" : "El día",
    "Who?" : "¿Quién?",
    "Impossible to get user/group list" : "Imposible obtener lista de usuarios/grupos",
    "No recommendations. Start typing." : "Sin recomendaciones. Comience a escribir.",
    "No result." : "Sin resultado.",
    "Quota rule created" : "Regla de cuota creada",
    "Failed to add quota rule" : "Fallo al añadir regla de cuota",
    "Quota rule deleted" : "Regla de cuota eliminada",
    "Failed to delete quota rule" : "Fallo al eliminar regla de cuota",
    "Rules can be set for specific groups or users. These rules will override the global quota settings." : "Las reglas pueden ser establecidas para grupos o usuarios específicos. Estas reglas pasarán por alto los ajustes globales de cuota.",
    "Only the rule with the highest priority is active if multiple rules match." : "Sólo la regla con la prioridad más alta estará activa si hay multiples reglas que coinciden.",
    "Add Quota rule" : "Añadir regla de cuota",
    "Quota rule saved" : "Regla de cuota guardada",
    "Rule {number}" : "Regla {number}",
    "Who this rule applies to?" : "¿A quién aplicará esta regla?",
    "Select users/groups" : "Seleccione usuarios/grupos",
    "Category" : "Categoría",
    "Shared quota" : "Cuota compartida",
    "Quota per user" : "Cuota por usuario",
    "Rule Priority" : "Prioridad de la regla",
    "Use shared quota" : "Utilizar cuota compartida",
    "Save" : "Guardar",
    "Delete" : "Eliminar",
    "Hide override config for {aiTask}" : "Ocultar configuración sobreescrita para {aiTask}",
    "Show override config for {aiTask}" : "Mostrar configuración sobreescrita para {aiTask}",
