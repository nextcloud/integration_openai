OC.L10N.register(
    ...
    "Image information was not found on the server. The data might have been cleaned up because the image has not been displayed during more than 10 days." : "لم يتم العثور على معلومات الصورة على الخادوم. ربما تم محو البيانات لأن الصورة لم يتم عرضها خلال أكثر من 10 أيام.",
    "Loading image" : "تحميل صورة",
    "Generated image" : "صورة مُولّدة",
    "The remote image cannot be fetched. OpenAI might have deleted it." : "لا يمكن استدعاء الصورة البعيدة remote. ربما قام OpenAI بحذفها.",
    ...
    "OpenAI API key" : "مفتاح واجهة برمجة تطبيقات OpenAI",
    ...
    "Preview text generation by OpenAI" : "معاينة توليد النص بواسطة OpenAI",
    "Submit text generated by OpenAI" : "إرسال النص الذي تم توليده بواسطة OpenAI",
    "Send" : "إرسال",
    ...
    "Failed to save OpenAI default model ID" : "فشل في حفظ مُعرِّف نموذج OpenAI الافتراضي",
    "OpenAI error" : "خطأ في OpenAI",
