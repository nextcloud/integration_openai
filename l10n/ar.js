OC.L10N.register(
    ...
    "Unknow API request error." : "خطأ غير محدد عند طلب API.",
    ...
    "A per-user limit for uasge of this API type (0 for unlimited))" : "حصة كل مستخدم لواجهة الاستخدام API من هذا النوع ( 0 تعني غير محدودة)) ",
