OC.L10N.register(
    ...
    "Extra completion model parameters (as a JSON object)" : "Parâmetros de modelo de conclusão extra (como um objeto JSON)",
    ...
    "Check the API documentation to get the list of all available parameters. For example: {example}" : "Verifique a documentação da API para obter a lista de todos os parâmetros disponíveis. Por exemplo: {exemplo}",
