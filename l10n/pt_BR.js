OC.L10N.register(
    ...
    "IBM watsonx.ai integration" : "Integração de IBM watsonx.ai",
    ...
    "Leave empty to use {watsonxApiUrl}" : "Deixar vazio para usar {watsonxApiUrl}",
    ...
    "API key (mandatory with watsonx.ai)" : "Chave de API (obrigatória com watsonx.ai)",
    ...
    "API key" : "Chave API",
    "A watsonx.ai project ID or space ID is required if an API key is specified" : "Um ID de projeto ou ID de espaço watsonx.ai é necessário se uma chave de API for especificada",
