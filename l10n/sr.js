OC.L10N.register(
    "integration_openai",
    {
    "Unknown error while clearing prompt history" : "Грешка приликом брисања историје захтева",
    ...
    "LocalAI's stable diffusion Text-To-Image" : "Стабилна дифузија Текст-у-слику компаније LocalAI",
    ...
    "Clear prompt history" : "Очисти историју захтева",
    "Clear text prompts" : "Обриши текстуалне захтеве",
    "Clear image prompts" : "Обриши захтеве слике",
    ...
    "Send" : "Пошаљи",
    "Include the prompt in the result" : "Укључи захетев у резултат",
