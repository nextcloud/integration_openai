OC.L10N.register(
    "integration_openai",
    {
    "Unknown error while clearing prompt history" : "Грешка приликом брисања историје одзива",
    "ChatGPT-like text generation (by OpenAI)" : "Генерисање текста као са ChatGPT (од OpenAI)",
    "ChatGPT-like text generation (with LocalAI)" : "Генерисање текста као са ChatGPT (са LocalAI)",
    "AI image generation (by OpenAI Dall-E 2)" : "AI генерисање слике (са OpenAI Dall-E 2)",
    "AI image generation (with LocalAI)" : "AI генерисање слике (са LocalAI)",
    "AI speech-to-text (Whisper via OpenAI)" : "AI говор-у-текст (Whisper преко OpenAI)",
    "AI speech-to-text (Whisper via LocalAI)" : "AI говор-у-текст (Whisper преко LocalAI)",
    "Unknown models error" : "Непозната грешка модела",
    "Unknown error while retrieving prompt history." : "Грешка приликом преузимања историје одзива",
    "Unknown error while clearing prompt history." : "Грешка приликом брисања историје одзива.",
    ...
    "Unknown image generation request error" : "Непозната грешка захтева за генерисања слике",
    "Image not found" : "Слика није пронађена",
    "Unknown image request error" : "Непозната грешка захтева слике",
    "Bad HTTP method" : "Лоша HTTP метода",
    "Bad credentials" : "Лоши креденцијали",
    "API request error: " : "Грешка API захтева: ",
    "Unknow API request error." : "Непозната грешка API захтева.",
    ...
    "LocalAI integration" : "LocalAI интеграција",
    "Reformulate" : "Реформулиши",
    "Formulate text in a different way." : "Формулише текст на другачији начин.",
    ...
    "API key (optional with LocalAI)" : "API кључ (није обавезно са LocalAI)",
    ...
    "A per-user limit for uasge of this API type (0 for unlimited))" : "Ограничење по кориснику за овај API тип (0 за без ограничења)",
    "Max new tokens per request" : "Максимални број жетон по захтеву",
    "Maximum number of new tokens generated for a single text generation prompt" : "Максимални број нових жетона који се генерише за један одзив за генерисање текста",
    ...
    "Image information was not found on the server. The data might have been cleaned up because the image has not been displayed for a long time." : "На серверу нису пронађене информације слике. Могуће је да су ти подаци очишћени јер је прошло доста времена од последњег приказивања слике.",
    "Loading image" : "Слика се учитава",
    "Generated image" : "Генерисана слика",
    "The remote image cannot be fetched. It may have been deleted due to not being viewed for a long time." : "Не може да се преузме удаљена слика. Можда је обрисана јер одавно није приказана.",
    ...
    "Clear prompt history" : "Очисти историју одзива",
    "Clear text prompts" : "Обриши текст одзиве",
    "Clear image prompts" : "Обриши одзиве слике",
    ...
    "Prompt history cleared" : "Историја одзива је обрисана",
    "Failed to clear prompt history" : "Није успело брисање историје одзива",
    ...
    "Preview text generation" : "Прегледај генерисање текста",
    "Submit generated text" : "Предај генерисани текст",
    "Send" : "Пошаљи",
    ...
    "by LocalAI" : "помоћу LocalAI",
    "Failed to save default model ID" : "Није успело чување подразумеваног ID модела",
    "Completion request error" : "Грешка захтева довршавања",
    "Unknown OpenAI API error" : "Непозната OpenAI API грешка",
    "Prompt" : "Одзив",
    "Result" : "Резултат",
    "Result {index}" : "Резултат {index}",
    "AI image generation" : "AI генерисање слике",
    "Preview images" : "Преглед слика",
    ...
    "API request error" : "Грешка API захтева",
    "Unknown image API error" : "Непозната грешка API слике",
