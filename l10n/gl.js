OC.L10N.register(
    ...
    "Translation provider (to translate Talk messages for example)" : "Provedor de tradución (para traducir mensaxes de Parlar, por exemplo)",
    ...
    "Speech-to-text provider (to transcribe Talk recordings for example)" : "Provedor de conversión de voz a texto (para transcribir as gravacións de Parlar, por exemplo)",
