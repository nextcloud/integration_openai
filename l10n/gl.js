OC.L10N.register(
    "integration_openai",
    {
    "Unknown error while clearing prompt history" : "Produciuse un erro descoñecido ao limpar o historial de indicacións",
    ...
    "Image information was not found on the server. The data might have been cleaned up because the image has not been displayed for a long time." : "Non se atopou información da imaxe no servidor. É posíbel que os datos se limparan porque a imaxe non se tiña amosado durante moito tempo.",
    "Loading image" : "Cargando a imaxe",
    "Generated image" : "Imaxe xerada",
    "The remote image cannot be fetched. It may have been deleted due to not being viewed for a long time." : "Non é posíbel obter a imaxe remota. É posíbel que fose eliminada porque non se tiña vista durante moito tempo.",
    ...
    "Clear prompt history" : "Limpar o historial de indicacións",
    "Clear text prompts" : "Borrar as indicacións de texto",
    "Clear image prompts" : "Borrar as indicacións de imaxe",
    ...
    "Prompt history cleared" : "Historial de indicacións limpo",
    "Failed to clear prompt history" : "Produciuse un fallo ao limpar o historial de indicacións",
