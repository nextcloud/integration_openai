OC.L10N.register(
    ...
    "IBM watsonx.ai integration" : "Integración de IBM watsonx.ai",
    "Integration of IBM watsonx AI services" : "Integración de servizos de IBM watsonx AI",
    "⚠ This app is still in early development\nand has only been tested with IBM watsonx.ai as a Service.\n\nThis app implements the following text generation providers\nusing any freely-available large language model:\nFree prompt, Summarize, Headline, Context Write, Chat, and Reformulate.\n\nYou can connect to the watsonx.ai service provided by IBM\nor to a self-hosted cluster running IBM Software Hub and related services.\n\n## Improve AI task pickup speed\n\nTo avoid task processing execution delay, setup at 4 background job workers in the main server (where Nextcloud is installed). The setup process is documented here: https://docs.nextcloud.com/server/latest/admin_manual/ai/overview.html#improve-ai-task-pickup-speed\n\n## Ethical AI Rating\n\n### Rating for Text generation via IBM watsonx.ai: 🟠\n\nPositive:\n* The provided foundation models are freely available, and thus can be ran on-premises\n\nNegative:\n* The software for training and inference of models is proprietary, limiting modifications to the API or other functionality\n* Some foundation models are trained on data that is not freely available, limiting the ability to fine tune them\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "⚠ Esta aplicación aínda está nunha fase inicial de desenvolvemento\ne só foi probada con «IBM watsonx.ai as a Service».\n\nEsta aplicación implementa os seguintes métodos de xeración de texto\nusando calquera modelo de linguaxe a grande escala libremente dispoñible:\nIndicación libre, Resumir, Titular, Escritura de contexto, Parola e Reformular.\n\nPode conectarse ao servizo watsonx.ai fornecido por IBM\nou a un clúster autoaloxado que executa IBM Software Hub e servizos relacionados.\n\n## Mellorar a velocidade de recollida de tarefas de IA\n\nPara evitar o atraso na execución do procesamento de tarefas, configure 4 traballadores de tarefas en segundo plano no servidor principal (onde está instalado Nextcloud). O proceso de configuración está documentado aquí: https://docs.nextcloud.com/server/latest/admin_manual/ai/overview.html#improve-ai-task-pickup-speed\n\n## Avaliación ética de IA\n\n### Avaliación para a xeración de texto a través de IBM watsonx.ai: 🟠\n\nPositiva:\n* Os modelos básicos fornecidos están dispoñíbeis de xeito libre e, polo tanto, poden executarse localmente\n\nNegativa:\n* O software para o adestramento e inferencia de modelos é propietario, limitando as modificacións da API ou outras funcionalidades\n* Algúns modelos básicos adestranse con datos que non están dispoñíbeis libremente, limitando a capacidade de axustalos\n\nObteña máis información sobre a avaliación de IA Ética de Nextcloud [no noso blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    ...
    "Watsonx.ai admin options saved" : "Gardáronse as opcións de administración de Watsonx.ai",
    "Failed to save watsonx.ai admin options" : "Produciuse un fallo ao gardar as opcións de administración de Watsonx.ai",
    "The Assistant app is not enabled. You need it to use the features provided by the watsonx.ai integration app." : "A aplicación asistente non está activada. Necesítaa para empregar as funcións que ofrece a aplicación de integración Watsonx.ai.",
    ...
    "This should include the domain name and API base path of your watsonx.ai instance. This URL will be accessed by your Nextcloud server." : "Isto debe incluír o nome de dominio e a ruta base da API da súa instancia watsonx.ai. O seu servidor de Nextcloud accederá a este URL.",
    ...
    "API key (mandatory with watsonx.ai)" : "Chave da API (obrigatoria con watsonx.ai)",
    "You can create an API key in your IBM Cloud IAM account settings" : "Pode crear unha chave API nos axustes IAM da súa conta IBM Cloud",
    "Cloud Resources" : "Recursos na nube",
    "Project ID" : "ID do proxecto",
    "Space ID" : "ID do espazo",
    "A watsonx.ai project ID or space ID is required to generate text" : "Precisase dun ID de proxecto watsonx.ai ou dun ID de espazo para xerar texto",
    ...
    "More information about IBM watsonx.ai as a Service" : "Máis información sobre IBM watsonx.ai como un servizo (SaS)",
    "More information about the IBM watsonx.ai software" : "Máis información sobre o software IBM watsonx.ai",
    ...
    "Watsonx.ai options saved" : "Gardáronse as opcións de Watsonx.ai",
    "Failed to save watsonx.ai options" : "Produciuse un fallo ao gardar as opcións de Watsonx.ai",
    ...
    "A watsonx.ai project ID or space ID is required if an API key is specified" : "Precisase dun ID de proxecto watsonx.ai ou dun ID de espazo se se especifica unha chave API",
